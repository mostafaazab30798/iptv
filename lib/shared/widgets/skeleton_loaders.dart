...
/// Skeleton shimmer effect for EPG Guide screen.
          ...
          Expanded(
            child: ListView.separated(
              ...
              itemBuilder: (context, index) => const Row(
                children: [
                  // Channel Card
                  ShimmerBox(width: 120, height: 56, borderRadius: 10),
                  SizedBox(width: 8),
                  // Program 1
                  Expanded(
                    flex: 2,
                    child: ShimmerBox(width: double.infinity, height: 56, borderRadius: 10),
                  ),
                  SizedBox(width: 8),
                  // Program 2
                  Expanded(
