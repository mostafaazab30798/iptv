...
/// Where the movie title sits relative to the poster art.
enum PosterTitlePlacement {
  /// Title under the poster (home rows, favorites/search grids).
  below,

  /// Title overlaid on the poster bottom (catalog grids filling 2:3 cells).
  overlay,
}
