...
final historyListProvider = FutureProvider.autoDispose<List<WatchHistoryEntry>>(
  (ref) async {
...
class _HistoryScreenState extends ConsumerState<HistoryScreen> {
  ...
  String _buildSubtitle(BuildContext context, WatchHistoryEntry item) {
    final dateStr =
        '\u200E${item.watchedAt.year}-${item.watchedAt.month.toString().padLeft(2, '0')}-${item.watchedAt.day.toString().padLeft(2, '0')}\u200E';
