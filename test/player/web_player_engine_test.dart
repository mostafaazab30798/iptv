...
void main() {
  group('WebVideoHandle', () {
    test('instantiates with viewTypeId and triggers onAspectRatioChanged callback', () {
      int? changedIndex;
  ...
  group('PlayerEngineFactory non-web behavior', () {
    ...
    test('createDefaultPlayerEngine defaults to MediaKitPlayerEngine on non-web', () {
  ...
  group('PlayerView handle rendering', () {
    testWidgets('renders placeholder when platformHandle is null or uninitialized', (tester) async {
